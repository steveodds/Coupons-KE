        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CouponCategory = table.Column<string>(nullable: false),
                    CouponCode = table.Column<string>(nullable: false),
                    Description = table.Column<string>(nullable: false),
                    ExpiryDate = table.Column<DateTime>(nullable: false),
                    Restrictions = table.Column<string>(nullable: false),
                    CouponUrl = table.Column<string>(nullable: false),
                    StoreSeller = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreLink = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreName = table.Column<string>(nullable: false),
                    StoreReflinkStart = table.Column<string>(nullable: false),
                    StoreReflinkEnd = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreWithLowestPrice = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
