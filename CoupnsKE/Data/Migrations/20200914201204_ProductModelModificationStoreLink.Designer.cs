...
namespace CoupnsKE.Data.Migrations
{
    ...
    [Migration("20200914201204_ProductModelModificationStoreLink")]
    partial class ProductModelModificationStoreLink
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CouponsKE.Models.Coupon", b =>
                {
                    ...
                    b.Property<int?>("UserCouponsID")
                        .HasColumnType("int");

                    b.HasKey("CouponID");

                    b.HasIndex("UserCouponsID");
            ...
            modelBuilder.Entity("CouponsKE.Models.Store", b =>
                {
                    ...
                    b.Property<string>("StoreReflink")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CouponsKE.Models.Coupon", b =>
                {
                    b.HasOne("CouponsKE.Models.UserCoupons", null)
                        .WithMany("Coupons")
                        .HasForeignKey("UserCouponsID");
                });
